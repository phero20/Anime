...
export default function Navbar() {
  ...
  return (
    <div className="relative z-50 text-lg ">
            ...
            <div className="flex flex-col gap-2">
              {
                allMobileItems.map((item) => (
                  <ScrollLink key={item}
                    ...
                    className={
                      `hover:border-b-2 border-[#f47521] hover:text-[#f47521] px-4 py-1 transition-all duration-200 cursor-pointer capitalize
      ...
      <nav className={
        `fixed top-0 ${activeSection != 'home' ? 'bg-[#030303]' : ''
        } left-0 w-screen right-0 text-[#F1EFEC] flex items-center justify-between px-4 lg:px-12 py-3 z-50`
      }>
      ...
      `
          ...
          <div className="relative">
            <div className={
              `flex items-center gap-2 cursor-pointer hover:border-b-2 border-[#f47521] hover:text-[#f47521] px-4 py-1 duration-200 transition-all
                ${moreItems.map(i => i.toLowerCase()).includes(activeSection) ? "text-[#f47521] border-b-2 border-[#f47521]" : ""
              }
              `
            }
              onClick={
